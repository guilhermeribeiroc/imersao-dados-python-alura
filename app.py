...
# define o titulo da pagina, o icone e o tamanho do layout para ocupar a largura inteira.
st.set_page_config(
...
# Criar um novo DataFrame filtrado com base nas escolhas dos filtros na barra lateral criada
#faz com que ele so trabalhe com os anos, senioridades, contratos e tamanho das colunas selecionadas
df_filtrado = df[
...
# -- Análise de graficos com Plotly --
...
with col_graf2:
    if not df_filtrado.empty:
        ...
        grafico_hist.update_layout(yaxis_title="Quantidade de Profissionais") 
